...
module.exports = {
    ...
    extend: {
      ...
      colors: {
        ...
        gray: {
          ...
          400: '#9ca3af',
          500: '#6b7280',
          600: '#4b5563',  // WCAG AA: 7.0:1 contrast ratio
          700: '#374151',  // WCAG AA: 10.7:1 contrast ratio
          800: '#1f2937',  // WCAG AAA: 15.3:1 contrast ratio
          900: '#111827',  // WCAG AAA: 18.7:1 contrast ratio
        }
      },
      ...
      boxShadow: {
        'elegant': '0 20px 25px rgba(0, 0, 0, 0.1), 0 25px 50px rgba(0, 0, 0, 0.25)',
  ...
  safelist: [
    ...
    'smooth-rendering',
    {
      pattern: /(bg|text|border)-(gray|black|white)-(50|100|200|300|400|500|600|700|800|900)/,
    },
    {
  ...
  // Dark mode strategy (for future implementation)
  darkMode: 'class',
}; 